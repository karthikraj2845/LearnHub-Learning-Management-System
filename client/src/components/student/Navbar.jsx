...
const Navbar = () => {
    ...
    const { user } = useUser()
    return (
        <div className={`flex items-center justify-between px-4 sm:px-10 md:px-14 lg:px-36 border-b border-orange-600 py-4 ${isCourseListPage ? 'bg-white' : 'bg-orange-600/70'}`}>
